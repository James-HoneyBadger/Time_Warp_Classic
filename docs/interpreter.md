...
The primary way to run programs is through the Time_Warp:
...
```bash
# Run a program file
python timewarp.py program.pilot

# Execute code directly
python timewarp.py -c "T:Hello World!"

# Specify language explicitly
python timewarp.py -l basic program.bas
```
