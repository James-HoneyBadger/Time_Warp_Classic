"""
TW Forth Language Executor for Time_Warp IDE
=============================================

TW Forth is an educational implementation of stack-based programming
inspired by classic Forth systems, designed for Time_Warp IDE.

This module handles TW Forth command execution including:
- Stack manipulation (DUP, DROP, SWAP, ROT)
- Arithmetic operations (+, -, *, /, MOD)
- Comparison operations (=, <, >)
- Control structures (IF, THEN, ELSE, BEGIN, UNTIL, WHILE, REPEAT)
- Word definition (: ;)
- Comments ()
- Basic I/O (. .S CR)
