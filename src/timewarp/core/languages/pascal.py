"""
TW Pascal Language Executor for Time_Warp IDE
==============================================

TW Pascal is an educational implementation of structured programming concepts
inspired by Turbo Pascal, designed for Time_Warp IDE.

This module handles TW Pascal command execution including:
