"""
TW Prolog Language Executor for Time_Warp IDE
===============================================

TW Prolog is an educational implementation of logic programming concepts
inspired by Turbo Prolog, designed for Time_Warp IDE.

This module handles TW Prolog command execution including:
- Facts and rules definition
- Queries and unification
- Backtracking
- Basic arithmetic and comparison
- List operations
- Simple I/O predicates
"""
